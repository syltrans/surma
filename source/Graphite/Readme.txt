...
Surma-glyphs.gdl contains the glyph definitions and glyph classes for the font. It is #included at the top of Surma-rules.gdl.

Surma-rules.gdl contains the rules for implementing the smart font behaviour.
